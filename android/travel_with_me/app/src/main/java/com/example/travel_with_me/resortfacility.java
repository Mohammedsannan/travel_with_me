...
public class resortfacility extends AppCompatActivity {
    ListView list4;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resortfacility);
        list4=findViewById(R.id.l4);
        sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        url = "http://" + sh.getString("ip", "") + ":5000/resortfacility_android";
        RequestQueue queue = Volley.newRequestQueue(resortfacility.this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    list4.setAdapter(new custom_resortfacility(resortfacility.this, name,image,description,fcid));
//                    l1.setOnItemClickListener(view_menu.this);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(resortfacility.this, "err" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @NonNull
            @Override
