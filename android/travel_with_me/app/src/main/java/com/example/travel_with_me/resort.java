...
public class resort extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ListView list2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = "http://" + sh.getString("ip", "") + ":5000/viewresort_android";
        RequestQueue queue = Volley.newRequestQueue(resort.this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    list2.setAdapter(new custom_viewresort(resort.this, name,image,place,rid));
//                    l1.setOnItemClickListener(view_menu.this);
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(resort.this, "err" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @NonNull
            @Override
