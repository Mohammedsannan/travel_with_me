...
public class touristplace extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_touristplace);
        list5=findViewById(R.id.l5);
        sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        url = "http://" + sh.getString("ip", "") + ":5000/touristplace_android";
        RequestQueue queue = Volley.newRequestQueue(touristplace.this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    list5.setAdapter(new custom_touristplace(touristplace.this,place,image,description,latitude,longitude,tid,rating));
//                    l1.setOnItemClickListener(view_menu.this);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(touristplace.this, "err" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @NonNull
            @Override
