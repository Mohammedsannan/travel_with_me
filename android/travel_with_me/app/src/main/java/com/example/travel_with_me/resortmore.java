...
public class resortmore extends AppCompatActivity {
    ImageView m1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resortmore);
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(),resortfacility.class);
                intent.putExtra("rid",rid);
                startActivity(intent);
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(),resortrating.class);
                intent.putExtra("rid",rid);
                startActivity(intent);
            }
        });
//        Toast.makeText(restaurantmore.this, "more..." +image+""+place, Toast.LENGTH_SHORT).show();
        url = "http://" + sh.getString("ip", "") + ":5000/viewmore_resort";
        RequestQueue queue = Volley.newRequestQueue(resortmore.this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(resortmore.this, "err" + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @NonNull
            @Override
    ...
    private void resort_rating() {
        url = "http://" + sh.getString("ip", "") + ":5000/view_resort_rating";
        RequestQueue queue = Volley.newRequestQueue(resortmore.this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
