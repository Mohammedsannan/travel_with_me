...
public class resortrating extends AppCompatActivity {
    EditText e1;
    Button b1;
    RatingBar rtng;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resortrating);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                RequestQueue queue = Volley.newRequestQueue(resortrating.this);
                url = "http://" + sh.getString("ip", "") + ":5000/resortrating_android";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (res.equalsIgnoreCase("success")) {
                                ...
                                Toast.makeText(resortrating.this, "Invalid", Toast.LENGTH_SHORT).show();
                            }
